...
<?php
	...
	$Foto='sinfoto.jpg';
	$insertSQL = "INSERT INTO mantenimiento (
	Cedula, Nombre, Apellido, Telefono, Celular, 
	Direccion, Correo, Serialbici, Marcabici, Colorbici, 
	Fechaentrada, Fechasalida, Diasalmacenamiento, Tipomantemiento, Valorabono, Foto) VALUES (
	'$Cedula', '$Nombre', '$Apellido', '$Telefono', '$Celular', '$Direccion',
	'$Correo', '$Serialbici', '$Marcabici', '$Colorbici', '$Fechaentrada', 
	'$Fechasalida', '$Diasalmacenamiento', '$Tipomantemiento', '$Valorabono', '$Foto')";
